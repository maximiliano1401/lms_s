...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Registro como Alumno</h2>
        <form action="procesar_registro_alumno.php" method="POST" class="mt-4">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="matricula" name="matricula" pattern="\d{5}" maxlength="5" required>
                </div>
            </div>
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="La contraseña debe contener al menos un número, una letra mayúscula y minúscula, y mínimo 8 caractéres" maxlength="16" required>
                </div>
            </div>
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="login_alumno.php">¿Ya tienes una cuenta? Inicia sesión aquí.</a>
        </div>
        <div class="text-center mt-3">
