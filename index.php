...
<div class="modal" id="loginModal" style="display:none;">
    <div class="modal-content">
        ...
        <div class="modal-buttons">
            <a href="login_maestro.php" class="btn"><i class="fas fa-chalkboard-teacher"></i> Ingresar como Maestro</a>
            <a href="login_alumno.php" class="btn"><i class="fas fa-user-graduate"></i> Ingresar como Alumno</a>
        </div>
    </div>
</div>
